...
$sql3 = "SELECT `Number` FROM `products` WHERE `ID` = 3";
...
<html lang="en">
  <head>
    ...
    <title>Sony Bravia 77 In | Indizon</title>
      ...
      <div class="container">
        <div class="row">
          <div style="padding-top: 7%;" class="col-lg-1">
                <span><img style="border: 1px solid; width:100%;margin: 5px; height: 20%;border-radius: 5%;" src="https://m.media-amazon.com/images/I/81ABJMRLcxL._SX679_.jpg" alt="i11.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/71p-0x-1fbL._SX679_.jpg" alt="i12.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/71GAdbLe0zL._SX679_.jpg" alt="i13.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/81m1KnsO3HL._SX679_.jpg" alt="i14.jpg"></span>
          </div>
          <div class="col-lg-11">
            <div class="row">
              <div class="col-lg-6">
                <img style="padding:20px;width: 100%;" src="https://m.media-amazon.com/images/I/81ABJMRLcxL._SX679_.jpg" alt="big-image.jpg">
              </div>
              <div class="col-lg-6">
                <div class="row" style="padding-top: 10%;">
                  <div style="padding: 5px;" class="col-lg-6">
                    <h3>
                      <!-- Name -->
                      Sony Bravia 195 cm (77 inches) XR series 4K Ultra HD Smart OLED Google TV XR-77A80J  
                    </h3>
                    ...
                    <div>
                      ...
                      <span style="display: inline-block;"><h2 style="font-weight: 200;">522490<sup>00</sup></h2></span>

                    </div>
                    <div>
                      <!-- Price -->
                      <span aria-hidden="true">M.R.P.: <i  style="display: inline-block;" class="fa-solid fa-indian-rupee-sign"></i>699900</span>
                    </div>                      
                    <h6 style="font-weight: 400;">Inclusive of all taxes
                      EMI starts at ₹24,595. No Cost EMI available <a href="">EMI</a></h6>
                      <div class="dropdown">
                  ...
                  <div class="col-lg-6">
                    <div class="card" style="width: 18rem;">
                      ...
                      <form class="card-body col-lg-12">
                        ...
                        <button type="submit" class="btn" style="background-color:  #ff8000;width: 100%;padding-left: 10%;padding-right: 10%;border-radius: 50px;" formaction="http://localhost/login2/sonybraviaOrder.php" formmethod="POST">Buy Now</button>
                      </form>
                    </div>
                  </div>
                </div>
