...
{
    $sql2 = "SELECT `Number` FROM `products` WHERE `ID` = 3";
    $result = $link->query($sql2);
    $row = $result->fetch_assoc();
    $temp = $row['Number'];

    $sql = "UPDATE `products` SET `Number` = $temp-1 WHERE `products`.`ID` = 3";
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col">
              ...
              Items:	₹522490
              <hr>
              <h3><div style="display: inline-block;color:#b12704;;">Order Total:	₹522490 </div></h3>
              <hr>
              <h6><div style="display: inline-block;color:#b12704;">Your Savings: ₹177410 (25%)  </div></h6>
