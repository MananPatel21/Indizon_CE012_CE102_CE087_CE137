...
$sql3 = "SELECT `Number` FROM `products` WHERE `ID` = 7";
...
<html lang="en">
  <head>
    ...
    <title>MicroSoft Surface Studio | Indizon</title>
      ...
      <div class="container">
        <div class="row">
          <div style="padding-top: 7%;" class="col-lg-1">
                <span><img style="border: 1px solid; width:150%;margin: 5px; height: 20%;border-radius: 5%;" src="https://m.media-amazon.com/images/I/61FszpWwU1L._SX569_.jpg" alt="big-iamge.jpg"></span>
                <span><img style="border: 1px solid; width:150%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/61UGE9cZVlL._SX569_.jpg" alt="img2.jpg"></span>
                <span><img style="border: 1px solid; width:150%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/61y4pQBEecL._SX569_.jpg" alt="img3.jpg"></span>
                <span><img style="border: 1px solid; width:150%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/81VtiwoBk4L._SX569_.jpg" alt="img4.jpg"></span>
          </div>
          <div class="col-lg-11">
            <div class="row">
              <div class="col-lg-6">
                <img style="padding: 50px;width: 100%;" src="https://m.media-amazon.com/images/I/61FszpWwU1L._SX569_.jpg" alt="big-image.jpg">
              </div>
              <div class="col-lg-6">
                <div class="row" style="padding-top: 10%;">
                  <div style="padding: 5px;" class="col-lg-6">
                    <h3>
                      <!-- Name -->
                      Microsoft Surface Studio 14.4 inches Touchscreen Intel ® Core i7 Laptop 
                    </h3>
                    ...
                    <div>
                      <span><h2  style="display: inline-block;color: red;margin-right: 5px;">-13%</h2></span>
                      <span><sup><i  style="display: inline-block;" class="fa-solid fa-indian-rupee-sign"></i></sup></span>
                      <span style="display: inline-block;"><h2 style="font-weight: 200;">373999<sup>00</sup></h2></span>

                    </div>
                    <div>
                      <!-- Price -->
                      <span aria-hidden="true">M.R.P.: <i  style="display: inline-block;" class="fa-solid fa-indian-rupee-sign"></i>429999</span>
                    </div>                      
                    <h6 style="font-weight: 400;">Inclusive of all taxes
                      EMI starts at ₹17,605. No Cost EMI available <a href="">EMI</a></h6>
                      <div class="dropdown">
                  ...
                  <div class="col-lg-6">
                    <div class="card" style="width: 18rem;">
                      ...
                      <form class="card-body col-lg-12">
                        ...
                        <button type="submit" class="btn" style="background-color:  #ff8000;width: 100%;padding-left: 10%;padding-right: 10%;border-radius: 50px;" formaction="http://localhost/login2/microsoftOrder.php" formmethod="POST">Buy Now</button>
                      </form>
                    </div>
                  </div>
                </div>
