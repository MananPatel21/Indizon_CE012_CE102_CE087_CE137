...
$sql3 = "SELECT `Number` FROM `products` WHERE `ID` = 2";
...
<html lang="en">
  <head>
    ...
    <title>Samsung Galaxy S22 Ultra | Indizon</title>
      ...
      <div class="container">
        <div class="row">
          <div style="padding-top: 7%;" class="col-lg-1">
                <span><img style="border: 1px solid; width:100%;margin: 5px; height: 20%;border-radius: 5%;" src="i11.jpg" alt="i11.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="i12.jpg" alt="i12.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="i13.jpg" alt="i13.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="i14.jpg" alt="i14.jpg"></span>
          </div>
          <div class="col-lg-11">
            <div class="row">
              <div class="col-lg-6">
                <img style="padding: 5px;width: 100%;" src="i11.jpg" alt="...">
              </div>
              <div class="col-lg-6">
                <div class="row" style="padding-top: 10%;">
                  <div style="padding: 5px;" class="col-lg-6">
                    ...
                    <div>
                      <span><h2  style="display: inline-block;color: red;margin-right: 5px;">-24%</h2></span>
                      <span><sup><i  style="display: inline-block;" class="fa-solid fa-indian-rupee-sign"></i></sup></span>
                      <span style="display: inline-block;"><h2 style="font-weight: 200;">121999<sup>00</sup></h2></span>

                    </div>
                    <div>
                      <!-- Price -->
                      <span aria-hidden="true">M.R.P.: <i  style="display: inline-block;" class="fa-solid fa-indian-rupee-sign"></i> 1619998</span>
                    </div>                      
                    <h6 style="font-weight: 400;">Inclusive of all taxes
                      EMI starts at ₹5,743. No Cost EMI available <a href="">EMI</a></h6>
                      <div class="dropdown">
                  ...
                  <div class="col-lg-6">
                    <div class="card" style="width: 18rem;">
                      ...
                      <form class="card-body col-lg-12">
                        ...
                        <button type="submit" class="btn" style="background-color:  #ff8000;width: 100%;padding-left: 10%;padding-right: 10%;border-radius: 50px;" formaction="http://localhost/login2/s22Order.php" formmethod="POST">Buy Now</button>
                      </form>
                    </div>
                  </div>
                </div>
