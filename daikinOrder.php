...
{
    $sql2 = "SELECT `Number` FROM `products` WHERE `ID` = 5";
    $result = $link->query($sql2);
    $row = $result->fetch_assoc();
    $temp = $row['Number'];

    $sql = "UPDATE `products` SET `Number` = $temp-1 WHERE `products`.`ID` = 5";
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col">
              ...
              <div style="display: inline-block;color: green">Tomorrow by 12pm </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col">
              ...
              Items:	₹44,990
              <hr>
              <h3><div style="display: inline-block;color:#b12704;;">Order Total:	₹44,990 </div></h3>
              <hr>
              <h6><div style="display: inline-block;color:#b12704;">Your Savings: ₹14,846 (33%)  </div></h6>
