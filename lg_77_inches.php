...
$sql3 = "SELECT `Number` FROM `products` WHERE `ID` = 4";
      ...
      <div class="container">
        <div class="row">
          <div style="padding-top: 7%;" class="col-lg-1">
                <span><img style="border: 1px solid; width:100%;margin: 5px; height: 20%;border-radius: 5%;" src="https://m.media-amazon.com/images/I/81s0JxBkzRL._SL1500_.jpg" alt="https://m.media-amazon.com/images/I/81s0JxBkzRL._SL1500_.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/916DBDD10pL._SX679_.jpg" alt="https://m.media-amazon.com/images/I/916DBDD10pL._SX679_.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/91oxyckjX7L._SX679_.jpg" alt="https://m.media-amazon.com/images/I/91oxyckjX7L._SX679_.jpg"></span>
                <span><img style="border: 1px solid; width:100%;margin: 5px;height: 20%;border-radius: 5%" src="https://m.media-amazon.com/images/I/51HdPep9KML._SY879_.jpg" alt="https://m.media-amazon.com/images/I/51HdPep9KML._SY879_.jpg"></span>
          </div>
          <div class="col-lg-11">
            <div class="row">
              <div class="col-lg-6">
                <img style="padding: 50px;width: 100%;" src="https://m.media-amazon.com/images/I/81s0JxBkzRL._SL1500_.jpg" alt="https://m.media-amazon.com/images/I/81s0JxBkzRL._SL1500_.jpg">
              </div>
              <div class="col-lg-6">
                <div class="row" style="padding-top: 10%;">
                  <div style="padding: 5px;" class="col-lg-6">
                    <h3>
                      <!-- Name -->
                      LG 195 cms (77 inches) 4K Ultra HD Smart OLED TV OLED77C9PTA | With Built-in Alexa
                    </h3>
                    ...
                    <div>
                      <span><h2  style="display: inline-block;color: red;margin-right: 5px;">-65%</h2></span>
                      <span><sup><i  style="display: inline-block;" class="fa-solid fa-indian-rupee-sign"></i></sup></span>
                      <span style="display: inline-block;"><h2 style="font-weight: 200;">3,49,999<sup>00</sup></h2></span>

                    </div>
                    <div>
                      <!-- Price -->
                      <span aria-hidden="true">M.R.P.: <i  style="display: inline-block;" class="fa-solid fa-indian-rupee-sign">6,49,991.00</i></span>
                    </div>                      
                    <h6 style="font-weight: 400;">Inclusive of all taxes
                      EMI starts at ₹16,476. No Cost EMI available <a href="">EMI</a></h6>
                      <div class="dropdown">
                  ...
                  <div class="col-lg-6">
                    <div class="card" style="width: 18rem;">
                      ...
                      <form class="card-body col-lg-12">
                        ...
                        <button type="submit" class="btn" style="background-color:  #ff8000;width: 100%;padding-left: 10%;padding-right: 10%;border-radius: 50px;" formaction="http://localhost/login2/lg77Order.php" formmethod="POST">Buy Now</button>
                        </form>
                    </div>
                  </div>
                </div>
