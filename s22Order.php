...
{
    $sql2 = "SELECT `Number` FROM `products` WHERE `ID` = 2";
    $result = $link->query($sql2);
    $row = $result->fetch_assoc();
    $temp = $row['Number'];

    $sql = "UPDATE `products` SET `Number` = $temp-1 WHERE `products`.`ID` = 2";
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col">
              ...
              Items:	₹121999
              <hr>
              <h3><div style="display: inline-block;color:#b12704;;">Order Total:	₹121999 </div></h3>
              <hr>
              <h6><div style="display: inline-block;color:#b12704;">Your Savings: ₹40001 (24%)  </div></h6>
