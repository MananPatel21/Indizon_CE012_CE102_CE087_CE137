...
{
    $sql2 = "SELECT `Number` FROM `products` WHERE `ID` = 7";
    $result = $link->query($sql2);
    $row = $result->fetch_assoc();
    $temp = $row['Number'];

    $sql = "UPDATE `products` SET `Number` = $temp-1 WHERE `products`.`ID` = 7";
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col">
              ...
              Items:	₹373999
              <hr>
              <h3><div style="display: inline-block;color:#b12704;;">Order Total:	₹373999 </div></h3>
              <hr>
              <h6><div style="display: inline-block;color:#b12704;">Your Savings: ₹56000 (13%)  </div></h6>
